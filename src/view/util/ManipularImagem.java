...
public class ManipularImagem {
    ...
    public static void exibiImagemLabel(String nome, javax.swing.JLabel label) {
        try {
            //primeiro verifica se tem a imagem
            //se tem convert para inputstream que é o formato reconhecido pelo ImageIO
            String caminho = System.getProperty("user.dir") + "\\src\\view\\capas_jogos\\";
            File entrada = new File(caminho + nome + ".jpg"); 
    ...
    public static void redirecionarImagem(BufferedImage imagem, String nome) {
        try {
            String caminho = System.getProperty("user.dir") + "\\src\\view\\capas_jogos\\";
