...
public class ClienteJogosDisponiveis extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tf_jogo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tf_jogoKeyReleased(evt);
            }
        });
    ...
    private void tf_jogoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf_jogoKeyReleased
        String jogo_pesquisado = tf_jogo.getText();

        if (jogo_pesquisado.isEmpty()) {
            carregar_tabela();
        } else {
            List retorno = JogosControler.getInstance().pesquisar_jogo(jogo_pesquisado);
            carregar_tabela(retorno);
        }

    }//GEN-LAST:event_tf_jogoKeyReleased
